import React, { useMemo, useState, useRef, useEffect } from '../../react/packages/react';
import './index.css';
      ...
      <div className="sliderContainer" ref={sliderContainerRef}>
        {
          dataList.map((data, index) => {
            return (
              <div className="slickSlide" data-index={index}><span>{data.title}</span><div>{index}</div></div>
            )
          })
        }
      </div>
